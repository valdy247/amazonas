...
export const authCopy = {
  es: {
    ...
    identityBody:
      "Tu identidad será validada más adelante con un documento oficial. Es importante que escribas tu nombre y apellidos tal como aparecen en tu documento para evitar retrasos en la verificación.",
    firstName: "Nombre",
    lastName: "Apellidos",
    phone: "Teléfono",
    email: "Correo",
    ...
    reviewerAccount: "Reseñador",
    providerAccount: "Proveedor",
    reviewerAccountBody: "Registro más completo para luego validar identidad y colaborar con más confianza.",
    providerAccountBody: "Acceso más rápido: correo, contraseña e intereses para empezar sin fricción.",
    ...
    signupEmailRateLimit: "Límite temporal de correo en Supabase. Espera un minuto y vuelve a intentar.",
    signupAlreadyRegistered: "Ese correo ya está registrado. Inicia sesión.",
    signinEmailNotConfirmed: "Debes confirmar tu correo antes de iniciar sesión.",
    signinInvalidCredentials: "Correo o contraseña incorrectos.",
    ...
    invalidSession: "No se recibió una sesión válida.",
    localSessionFailed: "La sesión se creó, pero no se pudo guardar localmente.",
    serverError: "No se pudo conectar con el servidor. Intenta otra vez.",
    experienceSpanishFirst: "Tu experiencia y tus mensajes se mostrarán primero en español.",
    spanishOptionHelp: "Ideal si prefieres registrarte y conversar en español.",
    englishOptionHelp: "Ideal si prefieres navegar y conversar en inglés.",
    active: "Activo",
    updatePassword: "Actualizar contraseña",
    providerInterestsHint: "Luego podrás completar más datos, pero por ahora solo te pediremos correo, contraseña e intereses.",
  },
  en: {
...
export const landingCopy = {
  es: {
    ...
    headline: "Verifyzon",
    heroEyebrow: "Red verificada de reseñadores para colaboraciones más seguras con marcas",
    ...
    reviewersEyebrow: "Para reseñadores",
    ...
    providersTitle: "Llega a reseñadores verificados con menos fricción",
    providersBody:
      "Descubre perfiles verificados, envía campañas y abre conversaciones desde un solo lugar, sin depender de contactos desordenados o canales dispersos.",
    providersTagOne: "Herramientas de campaña",
    ...
    footerTagline: "Una red pensada para colaboraciones más seguras, claras y profesionales.",
    footerLegal: "Legal",
    footerPrivacy: "Política de privacidad",
    footerTerms: "Términos y condiciones",
    footerAcceptableUse: "Uso aceptable",
    footerReviewIntegrity: "Integridad de reseñas",
...
export const profileCopy = {
  es: {
    ...
    selectCountry: "Selecciona tu país principal.",
    selectInterests: "Selecciona al menos 3 intereses.",
    directContactRequired: "Si activas contacto directo, agrega al menos una vía de contacto.",
    sessionError: "No se pudo validar tu sesión.",
    editProfile: "Editar perfil",
    adjustInfo: "Ajusta tu información",
    ...
    lastName: "Apellidos",
    focus: "Enfoque",
    reviewerFocus: "Cuéntanos qué te interesa reseñar y dónde aportas más valor.",
    providerFocus: "Define qué tipo de productos ofreces. Usaremos estas mismas etiquetas como categorías de producto para encontrar reseñadores afines.",
    selectCountryOption: "Selecciona tu país",
    reviewerNote: "Cuéntanos qué tipo de productos te gusta reseñar o en qué eres fuerte.",
    ...
    providerContactHelp: "Decide si tu perfil será visible para reseñadores y qué vías directas quieres compartir desde el inicio.",
    showProfileReviewer: "Mostrar mi perfil en el buscador de proveedores.",
    showProfileProvider: "Mostrar mi perfil a reseñadores compatibles.",
...
export const providerFinderCopy = {
  es: {
    title: "Encuentra reseñadores alineados con tus productos",
    body: "Filtra por país o categoría para descubrir reseñadores que encajen con tu marca.",
    filterCountry: "Filtrar por país",
    filterCategory: "Filtrar por categoría",
    allCountries: "Todos",
    allCategories: "Todas",
    recommendedBadge: "Recomendados para ti",
    recommendedTitle: "Reseñadores con mejor encaje",
    noCountry: "Sin país",
    compatible: "compatible",
    contact: "Contactar",
    reviewersFound: "reseñadores encontrados",
    clearFilters: "Limpiar filtros",
    verified: "Verificado",
    sessionError: "No se pudo validar tu sesión.",
    matchLabel: "Compatibilidad",
    contactTitle: "Contacto",
    contactBody: "Primero elige por dónde quieres contactar a este reseñador según lo que haya autorizado en su perfil.",
    contactMethods: "Métodos de contacto",
    contactMethodsBody: "Elige la vía más cómoda para empezar la conversación.",
    close: "Cerrar",
    opening: "Abriendo...",
    throughPlatform: "A través de la página",
  },
  en: {
...
export const providerContactsCopy = {
  es: {
    ...
    noPending: "Todavía no hay proveedores pendientes por contactar.",
    noContacted: "Aún no has abierto ningún contacto. Cuando abras uno aparecerá aquí automáticamente.",
    contactProviderTitle: "Contactar al proveedor",
    contactProviderBody: "Elige una vía de contacto para abrir directamente el perfil o canal del proveedor.",
    copyProviderTitle: "Copiar usuario del proveedor",
    copyProviderBody: "Copia el usuario visible para buscarlo manualmente en la app correcta.",
    contactVia: "Contactar por",
    copyVia: "Copiar usuario de",
    copiedPrefix: "Copiado",
    reportHelp: "Ayuda",
    reportTitle: "Ayudanos a revisar este contacto",
    reportBody: "Marca lo que mejor describa lo que paso con este proveedor. Este contacto seguira por verificar hasta que 2 reseñadores lo marquen como confiable.",
    reportNoReply: "No contesta",
    reportNotProvider: "No es un proveedor",
    reportTrusted: "Es confiable",
    reportScam: "Scam",
    reportBrokenContact: "Contacto dañado",
    reportSubmitSuccess: "Reporte enviado correctamente.",
    reportSubmitError: "No se pudo enviar el reporte.",
    reviewQueueHint: "Solo pasara a verificado cuando 2 reseñadores lo marquen como confiable.",
  ...
  en: {
    ...
    copyProviderTitle: "Copy provider username",
    copyProviderBody: "Copy the visible username so you can search for it manually in the correct app.",
    contactVia: "Contact via",
    copyVia: "Copy username from",
    copiedPrefix: "Copied",
    reportHelp: "Help",
    reportTitle: "Help us review this contact",
    reportBody: "Choose the option that best describes what happened with this provider. This contact will stay pending verification until 2 reviewers mark it as trusted.",
    reportNoReply: "No reply",
    reportNotProvider: "Not a provider",
    reportTrusted: "Trusted",
    reportScam: "Scam",
    reportBrokenContact: "Broken contact",
    reportSubmitSuccess: "Report submitted successfully.",
    reportSubmitError: "The report could not be submitted.",
    reviewQueueHint: "It will only become verified once 2 reviewers mark it as trusted.",
...
export const navigationCopy = {
  es: {
    ...
    editProfile: "Editar perfil",
    reviewerSearch: "Buscar reseñadores",
    createAccount: "Crear cuenta",
    signIn: "Iniciar sesión",
...
export const providerCampaignCopy = {
  es: {
    ...
    body:
      "Envía un mismo mensaje a todas las reseñadoras que encajen contigo o solo a un grupo filtrado por intereses. La IA puede ayudarte a dejar el mensaje más claro, cálido y listo para convertir.",
    allReviewers: "Todas",
    sendToAll: "Todo el directorio",
    selectedAudience: "Audiencia seleccionada",
    recipients: "reseñadoras",
    noReviewers: "No hay reseñadoras disponibles con ese filtro ahora mismo.",
    messageLabel: "Mensaje principal",
    messagePlaceholder: "Ej: Hola, tengo una línea de belleza y me gustaría colaborar contigo en una campaña puntual.",
    improveWithAi: "Mejorar con IA",
    improving: "Mejorando...",
    sendCampaign: "Enviar a",
    sendingCampaign: "Enviando campaña...",
    sentOk: "Tu mensaje ya se envio y las conversaciones quedaron listas en Mensajes.",
    sendError: "No se pudo enviar la campaña.",
    aiError: "No se pudo mejorar el mensaje con IA.",
    emptyMessage: "Escribe el mensaje antes de enviarlo.",
    audienceLabel: "Segmentar por interés",
    previewLabel: "Vista previa",
    openMessages: "Abrir mensajes",
    audienceSummaryAll: "Se enviará a todas las reseñadoras visibles.",
    audienceSummaryFiltered: "Se enviará solo a quienes coincidan con este interés.",
  },
  en: {
    badge: "AI outreach",
    title: "Campaign Studio",
...
export const dashboardCopy = {
  es: {
    ...
    visibleProfileBody:
      "Tu perfil verificado ayudará a que los proveedores confíen más rápido en ti y puedan avanzar contigo sin tanta fricción en la colaboración.",
    safeContactTitle: "Contacto más seguro",
    safeContactBody:
      "Puedes hablar con proveedores desde la página sin compartir tus datos personales y decidir con calma cómo quieres que te contacten.",
    ...
    providerMessagesDescription:
      "Selecciona categoría, agrega el nombre del producto y habla con el reseñador desde un solo lugar.",
    reviewerMessagesDescription: "Habla con proveedores desde aqui y comparte imagenes cuando lo necesites.",
    emptyConversationsTitle: "Todavía no tienes conversaciones activas",
    providerEmptyConversationsBody:
      "Contacta a un reseñador desde la página y la conversación aparecerá aquí al instante.",
...
export const supportCopy = {
  es: {
    ...
    allTickets: "Casos",
    noTickets: "No hay casos de soporte todavía.",
    changeStatus: "Cambiar estado",
    assignToMe: "Tomar caso",
    assignedToMe: "Caso tomado",
    assignedTo: "Asignado a",
    unassigned: "Aun sin responsable asignado",
...
export const pushPromptCopy = {
  es: {
    ...
    stepsLabel: "Que hacer",
    iosStepInstall: "Abre esta web en Safari y agregala a tu pantalla de inicio para usarla como app.",
    iosStepOpen: "Abre la app instalada desde tu pantalla de inicio, no desde una pestana normal.",
    iosStepAllow: "Toca permitir cuando iPhone te pida activar las notificaciones.",
    iosStepKeep: "Deja la sesión iniciada para seguir recibiendo avisos de mensajes nuevos.",
    generalStepAllow: "Permite las notificaciones cuando el navegador te lo pida.",
    generalStepKeep: "Mantente con la sesión iniciada para recibir avisos de mensajes nuevos.",
  ...
  en: {
    ...
    iosStepInstall: "Open this website in Safari and add it to your Home Screen to use it like an app.",
    iosStepOpen: "Open the installed app from your Home Screen, not from a regular browser tab.",
    iosStepAllow: "Tap allow when your iPhone asks to enable notifications.",
    iosStepKeep: "Stay signed in so you can keep receiving alerts for new messages.",
    generalStepAllow: "Allow notifications when the browser asks for permission.",
    generalStepKeep: "Stay signed in to keep receiving alerts for new messages.",
...
export const onboardingCopy = {
  es: {
    ...
    providerRoleCopy: "Activaremos un perfil más ligero para que puedas entrar rápido y definir tus intereses de producto.",
    ...
    providerInterestsMin: "Selecciona al menos 3 categorías de producto para encontrar reseñadores afines.",
    ...
    providerDescription: "Quiero preparar mi perfil según los productos que ofrezco para encontrar reseñadores relevantes.",
    essentials: "Completa lo esencial",
    essentialsBody: "Este paso debe sentirse rapido en movil, sin campos innecesarios.",
    providerEssentialsBody: "Como proveedor, lo dejaremos ligero: podrás completar más datos después desde tu perfil.",
    firstName: "Nombre",
    lastName: "Apellidos",
    phone: "Teléfono",
    ...
    providerInterestTitle: "Qué tipo de productos ofreces",
    reviewerInterestBody: "Estas etiquetas nos ayudan a personalizar el dashboard y futuros matches.",
    providerInterestBody: "Usaremos estas mismas etiquetas como categorías de producto para encontrar reseñadores compatibles.",
    experienceLevel: "Nivel de experiencia",
    experienceLevelBody: "Elige el punto que mejor describe en que etapa te encuentras ahora.",
    visibilityContactTitle: "Visibilidad y contacto",
    reviewerContactHelp: "Decide si los proveedores pueden encontrarte y si quieres mostrar vias de contacto directo desde ahora.",
    providerContactHelp: "Decide si tu perfil será visible para reseñadores y qué vías directas quieres compartir desde el inicio.",
    showProfileReviewer: "Mostrar mi perfil a proveedores compatibles.",
    showProfileProvider: "Mostrar mi perfil a reseñadores compatibles.",
    allowDirectContact: "Permitir contacto directo por WhatsApp, Instagram o Messenger.",
    whatsappPlaceholder: "WhatsApp. Ej: +1786703994",
    instagramPlaceholder: "Instagram. Ej: instagram.com/usuario",
    ...
    mainRegionBody: "Elegimos un país base para mostrar oportunidades y matches relevantes primero.",
    ...
    productMapBody: "Selecciona al menos 3 categorías de producto para encontrar reseñadores afines.",
    ...
    summaryBody: "El objetivo es activar tu perfil sin fricción y dejar una base clara para agregar pasos después.",
    providerProfilePending: "Perfil ligero activado. Luego podrás completar más datos desde tu panel si lo necesitas.",
    role: "Rol",
    profile: "Perfil",
  ...
  en: {
    ...
    experienceLevelBody: "Choose the option that best describes the stage you are in right now.",
    visibilityContactTitle: "Visibility and contact",
    reviewerContactHelp: "Decide whether providers can find you and whether you want to share direct contact methods from the start.",
    providerContactHelp: "Decide whether your profile will be visible to reviewers and which direct channels you want to share from the beginning.",
    showProfileReviewer: "Show my profile to compatible providers.",
    showProfileProvider: "Show my profile to compatible reviewers.",
    allowDirectContact: "Allow direct contact through WhatsApp, Instagram, or Messenger.",
    whatsappPlaceholder: "WhatsApp. Ex: +1786703994",
    instagramPlaceholder: "Instagram. Ex: instagram.com/username",
    messengerPlaceholder: "Messenger. Ex: m.me/username",
