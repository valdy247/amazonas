...
export const providerContactsCopy = {
  es: {
    ...
    reportBody: "Marca lo que mejor describa lo que paso con este proveedor. Si varios reseñadores coinciden, el caso pasara a revision del equipo.",
  ...
  en: {
    ...
    reportBody: "Choose the option that best describes what happened with this provider. If multiple reviewers agree, the case will move into admin review.",
